...
_start:
    ...
    while:
        ...
        not_enter:
            cmp byte [rsp + rcx], 'A'   ; сравниваем симвлол с буквой "А"
            je is_a                     ; если это "А", прыгаем на is_a
            jmp continue                ; иначе прыгаем на continue
        is_a:
            inc byte rdx                ; увеличиваем счетчик букв "А" в слове
            jmp continue                ; прыгаем на continue
        end_of_word:
            mov rax, rdx                ; rax = rdx
            mov rdx, 0                  ; обнуляем rdx
            cmp rax, 3                  ; сравниваем кол-во букв "А" в слове с 3
            jg more                     ; если больше 3, прыгаем на more
            jmp continue_end            ; иначе прыгаем на continue_end
            more:
