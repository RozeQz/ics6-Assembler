...
_start:
    ...
    cycle_row:              ; внешний цикл для строк
        ...
        add rbx, 4                  ; rbx = (номер текущей строки - 1) * 5 + 4             
        sub rbx, rcx                ; rbx = индекс элемента матрицы, совпадающий с (5 - номер строки, в которой он находится)
        mov [matrix + rbx*4], eax   ; matrix[rbx] = среднеарифметическое строки
